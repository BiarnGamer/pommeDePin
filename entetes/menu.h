...
#define MENU_GESTION_MODIF_ENCLOS 3
#define MENU_GESTION_BARNEY 4
#define MENU_GESTION_MODIF_ANIMAL 5
#define MENU_GESTION_DEPLACER 6
#define MENU_GESTION_RELACHER 7
